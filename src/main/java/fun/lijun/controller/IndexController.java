...
import fun.lijun.entity.PageBean;
import fun.lijun.service.BlogService;
import fun.lijun.util.PageUtil;
import fun.lijun.util.StringUtil;
...
public class IndexController {
	...
	public ModelAndView index(@RequestParam(value="page",required=false) String page,
		...
		mav.addObject("pageCode",PageUtil.genPagination(request.getContextPath()+"/index.html", blogService.getTotal(map), Integer.parseInt(page),
				10, param.toString()));
