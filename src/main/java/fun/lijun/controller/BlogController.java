...
import fun.lijun.lucene.BlogIndex;
...
public class BlogController {
	...
	private String genUpAndDownPageCode(Integer page,Integer totalNum,String q,Integer pageSize,String projectContext){
		...
		if(totalPage==0){
			...
			if(page>1){
				pageCode.append("<li><a href='"+projectContext+"/blog/q.html?page="+(page-1)+"&q="+q+"'>last</a></li>");
			}else{
				pageCode.append("<li class='disabled'><a href='#'>last</a></li>");
			}
			if(page<totalPage){
