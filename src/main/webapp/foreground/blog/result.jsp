		  		...
		  		<c:otherwise>
		  			<c:forEach var="blog" items="${blogList}">
		  				<li style="margin-bottom: 20px">
						  	...
						  	<span class="link"><a href="${pageContext.request.contextPath}/blog/articles/${blog.id }.html">http://lijun.fun/blog/articles/${blog.id }.html</a>&nbsp;&nbsp;&nbsp;&nbsp;发布日期：${blog.releaseDateStr }</span>
						  </li>
		  			</c:forEach>
		  		</c:otherwise>
		  	</c:choose>
