	  		...
	  		<div class="datas">
	  			<ul>
	  				...
	  				<li style="margin-bottom: 30px">
	  					<span class="date"><a href="${pageContext.request.contextPath}/blog/articles/${blog.id }.html"><fmt:formatDate value="${blog.releaseDate }" pattern="yyyy年MM月dd日"/></a></span>
					  	...
					  	<span class="info">发表于 <fmt:formatDate value="${blog.releaseDate }" pattern="yyyy-MM-dd HH:mm"/> 阅读(${blog.clickHit}) 评论(${blog.replyHit }) </span>
